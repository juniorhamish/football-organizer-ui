...
import { BoxShadowOutlinedInput, FormCard, FormContainer, FormControlField, FormGrid, PasswordField, ProgressIndicator } from '../components';
...
export default function SignUp({ onSignUp }: { onSignUp: (username: string) => void }) {
  ...
  return (
    <>
      <ProgressIndicator open={signUpInProgress} label="Sign up in progress" />
      <FormContainer>
        <FormCard onSubmit={signUp} aria-label="Sign Up Form" aria-busy={signUpInProgress}>
